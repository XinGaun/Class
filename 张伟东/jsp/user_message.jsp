...
<!-- <div class="panel panel-default" id="order_div"style="width:70%;filter:alpha(opacity=20);opacity:0.7!important;margin:180px 0px 0px 20px;float:left;">
	...
	<div style="margin-top:140px;">
			<div class="login-agileinfo"> 
				<form action="userInfoAction_uersReg.action" method ="post"> 
					<input class="agile-ltext" type="text" name="Mobile" id="Mobile"placeholder="手机号" readonly="readonly" value="${userMessage[0].Mobile }">
					<input class="agile-ltext" type="text" name="UserName" id="UserName"  placeholder="姓名" value="${userMessage[0].UserName }">
					<input class="agile-ltext" type="text" name="UserAddress" id="UserAddress" placeholder="地址" value="${userMessage[0].UserAddress }"required="">
					<input type="radio" name="UserSex" ${userMessage[0].UserSex=='男'? 'checked="checked"':''} value="男">男
					<input type="radio" name="UserSex" ${userMessage[0].UserSex=='女'? 'checked="checked"':''} value="女">女
					<input type="submit" id="update_btn" value="修  &nbsp;改">
				</form>
			</div>	 
		</div>
  </body>
