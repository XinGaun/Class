...
<body>
	...
	<form action="Hlogin_updetestaff.action" method="post"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input type="radio" id="sex-2" value="女" name="sex"> <label
						for="sex-2">女</label>
				</div>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" name="age">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input id="cardid" type="text" class="input-text" value=""
					placeholder="" name="cardID"><span id="span"></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" name="Mobile"><span></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" name="Userpwd">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<div id="prcicou">
						...
						<input type="text" name="province" id="province" style="display:none"/>
						<input type="text" name="city" id="city"style="display:none"/>
						<input type="text" name="county" id="county"style="display:none"/>
					</div>
				<div id="show"></div> </span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="Rdate" id="today">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box"> <select class="select" size="1"
					name="departid">
						...
						<!--				 
					<option value="北京" name = "Addres">北京</option>
					<option value="上海" name = "Addres">上海</option>
					<option value="广州" name = "Addres">广州</option>
-->
				</select> </span>
			</div>
		</div>
		...
		$("#cardid").blur(
			function() {
				if ((!(/^1[3|4|5|8][0-9]\d{4,8}$/).test($(this).val()))&&($(this).val()=="")) {
					$("#span").html("<p style='color:red'>证件号不正确!</p>");
				}else {
					$.ajax({
						type : "post",
						url : "Hlogin_solestaffcard.action",
						data : {
							"cardID" : $("#cardid").val()
							},
						dataType : "text",
						success : function(data) {
							if (data != 0) {
								...
								$("#span").html("<p style='color:red'>证件号不可重复</p>");
								a = 1;
							}
						}
					});
