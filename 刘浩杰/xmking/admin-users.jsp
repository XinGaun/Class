...
<title>用户管理 - 管理员管理 - H-ui.admin 3.0</title>
		...
		<dl id="menu-admin">
			...
			<dd style="display:block">
				<ul>
					...
					<li class="current"><a href="admin-users.jsp" title="用户管理">用户管理</a></li>
...
<section class="Hui-article-box" id="dd">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_users_add('添加用户','admin-users-add.jsp','','310')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong>1</strong> 条</span> </div>
			<table class="table table-border table-bordered table-bg">
				...
				<tbody>
					<tr class="text-c">
						...
						<td>河南</td>
						<td></td>
						<td><a title="编辑" href="javascript:;" onclick="admin_users_edit('角色编辑','admin-users-add.jsp','1','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_users_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</tbody>
			</table>
		</article>
...
*/
/*管理员-权限-添加*/
function admin_users_add(title,url,w,h){
	layer_show(title,url,w,h);
}
/*管理员-权限-编辑*/
function admin_users_edit(title,url,id,w,h){
	layer_show(title,url,w,h);
}

/*管理员-权限-删除*/
function admin_users_del(obj,id){
