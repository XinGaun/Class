...
<title>角色管理 - 管理员管理 - H-ui.admin 3.0</title>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li class="current"><a href="article-list.jsp" title="资讯管理">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-admin">
			...
			<dd style="display: block;">
				<ul>
					<li class="current"><a href="admin-role.jsp" title="角色管理">角色管理</a></li>
