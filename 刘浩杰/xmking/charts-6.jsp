...
<title>3D柱状图 - 系统统计 - H-ui.admin 3.0</title>
		...
		<dl id="menu-tongji">
			...
			<dd style="display:block">
				<ul>
					...
					<li class="current"><a href="charts-6.jsp" title="3D柱状图">3D柱状图</a></li>
...
$(function () {
    ...
    function showValues() {
        $('#R0-value').jsp(chart.options.chart.options3d.alpha);
        $('#R1-value').jsp(chart.options.chart.options3d.beta);
    }
    showValues();
});
</script>
