				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="105">桌台状态</th>
							<th width="105">桌台种类</th>
							<th width="100">操作</th>
						</tr>
					</thead>
					<tbody>
					<c:if test="${empty listone}">
							<tr>
								<td colspan="5">没有此桌台</td>
							</tr>
					</c:if>
					<c:forEach items="${listone }" var="lione">
						<tr class="text-c">
							<td>${lione.deskID }</td>
							<td>${lione.deskSize}</td>
							<td>${lione.statuname}</td>
							<td>${lione.ztclassname}</td>
							<td class="td-manage"><a style="text-decoration:none" class="ml-5 a"  onClick="picture_edit('图库编辑','picture-add.jsp','10001')" href="login_update.action?user=${lione.deskID }" value="deskID"/><i class="Hui-iconfont">&#xe6df;</i>使用</a> <a style="text-decoration:none" class="ml-5 a"  onClick="picture_del(this,'10001')"  href="login_update1.action?use=${lione.deskID }" value="deskID"/><i class="Hui-iconfont">&#xe6e2;</i>取消</a></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
